...
Bespoke Icons Created For Mheadley Basic
License: Creative Commons Zero (CC0), https://creativecommons.org/publicdomain/zero/1.0/
...
- mhbasictheme_SVG_Icons
- mhbasictheme_the_theme_svg()
- mhbasictheme_get_theme_svg()
- mhbasictheme_nav_menu_social_icons()
