 ...
 * @return {Object} - this
 */
function _mhbasicthemeColor( backgroundColor, accentHue ) {
 ...
 * @return {Object} - this
 */
_mhbasicthemeColor.prototype.setAccentColorsArray = function() {
	var self = this,
		minSaturation = 65,
		maxSaturation = 100,
		minLightness = 30,
 ...
 */
_mhbasicthemeColor.prototype.getTextColor = function() {
 ...
 * @return {Color} - Returns a Color object.
 */
_mhbasicthemeColor.prototype.getAccentColor = function() {
	var fallback;
...
/**
 * Return a new instance of the _mhbasicthemeColor object.
 *
 * @since 1.0.0
 * @param {string} backgroundColor - The background color.
 * @param {number} accentHue - The hue for our accent color.
 * @return {Object} - this
 */
function mhbasicthemeColor( backgroundColor, accentHue ) {// jshint ignore:line
	var color = new _mhbasicthemeColor( backgroundColor, accentHue );
