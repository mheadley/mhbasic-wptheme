...
<article <?php post_class(); ?> id="post-<?php the_ID(); ?>">
	...
	$image_url = ! post_password_required() ? get_the_post_thumbnail_url( get_the_ID(), 'mhbasictheme-fullscreen' ) : '';
							...
							if ( is_page() ) {
								...
								<div class="to-the-content-wrapper">
									...
									<a href="#post-inner" class="to-the-content fill-children-current-color">
										<?php mhbasictheme_the_theme_svg( 'arrow-down' ); ?>
										<div class="screen-reader-text"><?php _e( 'Scroll Down', 'mhbasictheme' ); ?></div>
									</a><!-- .to-the-content -->
	...
	<div class="post-inner" id="post-inner">
		...
		<div class="entry-content post-content-list-container">
