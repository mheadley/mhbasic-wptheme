<?php
/**
 * A template partial to output pagination for the Mheadley Basic default theme.
 *
 * 
 *
 * @package Mheadley
...
$prev_text = sprintf(
	...
	__(  ' Newer &emsp;', 'mhbasictheme' )
);
$next_text = sprintf(
	'<span class="nav-next-text"> %s </span> %s',
	__( '&emsp; Older ', 'mhbasictheme' ),
...
if ( $posts_pagination ) { ?>
	...
	<div class="pagination-wrapper section-inner">
		<div class="content-wrap"><div class="lyt"><?php echo $posts_pagination; //phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- already escaped during generation. ?></div></div>
